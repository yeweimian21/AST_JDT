...
public class Absence implements Serializable {
	 ...
	 * @return un intero che rappresenta l'id della giustifica relativa all'assenza, oppure null se l'assenza non ии stata giustificata
	 */
	 ...
	 * @return un intero che rappresenta l'anno in cui ии iniziato l'anno accademico 
	 */
